// Command 47-mdns-discovery finds a peer on the local link with multicast DNS.
//
...
// 05-memory-discovery hands addresses around inside one process, which is what
// a test wants; 14-dns-resolve and 15-pkarr-publish-resolve ask n0's public
// DNS and pkarr infrastructure; 27-local-infra runs that same pkarr relay
