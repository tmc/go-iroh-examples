// Command 40-iroh-ping answers a ping over an iroh connection.
//
...
//
// That is the reason to read this example rather than 04-router-echo, which
...
// there is exactly one message. 41-framed-messages keeps the stream open for
