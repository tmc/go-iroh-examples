// Command go-iroh-datagram-frames sends application frames as QUIC datagrams.
//
...
//
// See go-iroh-datagram-vs-stream for choosing between the two, and go-iroh-uni-streams for
