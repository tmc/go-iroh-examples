// Command go-iroh-connect-public dials a peer given its ID and its coordinates.
//
// It is the dialing half of go-iroh-public-server, and it shows what a
...
//
// go-iroh-dns-resolve and go-iroh-pkarr-publish-resolve build the same address from an ID
// alone by asking a discovery service; go-iroh-tickets carries it as one
...
func run(args []string) error {
	fs := flag.NewFlagSet("go-iroh-connect-public", flag.ContinueOnError)
