// Command 46-docs-sync replicates a multi-writer document between two peers.
//
...
// document-shaped analog of the endpoint ticket in 38-app-envelope-ticket, and
...
// live in a blob store and move over the iroh-blobs protocol (16-sendme-file),
