// Command 41-framed-messages exchanges chess moves as length-prefixed frames.
//
// This is the Go port of the framed-messages example from n0's iroh-examples,
// and it answers the question a reader has after 40-iroh-ping: how do two peers
...
//
// 34-uni-streams takes the other approach: one stream per message, with the
