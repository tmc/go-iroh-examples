// Command 30-transport-tuning tunes an endpoint's QUIC transport settings.
//
...
//
// Compare 39-datagram-vs-stream for what a datagram is good for, and
// 33-path-upgrade for the paths those last two constants are about.
package main
