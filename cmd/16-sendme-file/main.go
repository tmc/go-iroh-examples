// Command 16-sendme-file serves one blob and fetches it whole.
//
...
//
// Compare 20-resumable-chunks, which asks for a chunk range of a blob instead
...
func run(args []string) error {
	fs := flag.NewFlagSet("16-sendme-file", flag.ContinueOnError)
