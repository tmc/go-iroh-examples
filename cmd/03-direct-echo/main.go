// Command 03-direct-echo connects two endpoints and echoes one message.
//
...
// 04-router-echo hands the same loop, and the error handling around it, to
// [iroh.Router].
//
...
// 05-memory-discovery drops the assumption that the client already knows where
// the server is.
package main
