// Command 13-relay-online joins the public relay map and waits to be reachable.
//
...
// until -live is passed. 27-local-infra runs the same shape against an
// in-process relay server and needs no network; 28-net-report shows
// what the probing measured; 11-public-server folds this opt-in into a server.
package main
...
func run(args []string) error {
	fs := flag.NewFlagSet("13-relay-online", flag.ContinueOnError)
