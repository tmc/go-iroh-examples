// Command 17-dumbpipe pipes stdin to stdout over an iroh connection.
//
...
// directions until either side closes. A ticket printed by "17-dumbpipe listen"
...
// "go run ./cmd/17-dumbpipe" is a complete demo. Otherwise:
//
//	17-dumbpipe listen [-alpn v] [-no-relay] [-bind addr:port] [-advertise addr:port] [-key file] [-ticket file]
//	17-dumbpipe connect [-alpn v] [-bind addr:port] <endpoint-ticket>
//
