// Command 07-source-validation makes a peer prove its source address.
//
...
// the first of the stages 06-manual-incoming unrolls, and why it is the fact
// worth filtering on in 36-incoming-filter.
package main
