// Command 26-stream-netconn-deadline uses an iroh stream as a net.Conn.
//
...
//
// Compare 31-stream-listener, which wraps the accept side as a [net.Listener]
// so an existing server loop can serve iroh peers unchanged, and
// 25-http-over-iroh, which runs net/http over exactly these connections.
package main
