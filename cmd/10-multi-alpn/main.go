// Command 10-multi-alpn serves two protocols from one endpoint.
//
...
// the handler whose ALPN it negotiated. 04-router-echo is this example with one
...
// (34-uni-streams, 41-framed-messages).
package main
