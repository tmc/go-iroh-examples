// Command 08-hooks observes dialing from inside the endpoint.
//
// [iroh.EndpointHooks] is the dialing side's counterpart to the accepting-side
// decision points in 06-manual-incoming, 07-source-validation, and
// 36-incoming-filter. [iroh.WithHooks] registers an implementation on an
...
// application code the peer can read (35-close-codes). Hooks are therefore the
