// Command go-iroh-rpc-workqueue dispatches concurrent RPC jobs over one connection.
//
...
//
// Choose this over framing messages by hand — go-iroh-framed-messages — when the
